...
Server-side endpoint that provides client tokens to the browser. This endpoint validates origin and returns a client token for DataClient initialization.
