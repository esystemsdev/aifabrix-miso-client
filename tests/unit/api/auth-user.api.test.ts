...
describe("AuthUserApi", () => {
  ...
  describe("getUser", () => {
    ...
    it("should handle errors", async () => {
      ...
      await expect(authUserApi.getUser(authStrategy)).rejects.toThrow(
        "Get user failed",
      );
  ...
  describe("logoutWithToken", () => {
    ...
    it("should handle errors", async () => {
      ...
      await expect(authUserApi.logoutWithToken(token)).rejects.toThrow(
  ...
  describe("handleCallback", () => {
    ...
    it("should handle errors", async () => {
      ...
      await expect(authUserApi.handleCallback(params)).rejects.toThrow(
