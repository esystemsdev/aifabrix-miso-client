...
describe("LogsListApi", () => {
  ...
  describe("listGeneralLogs", () => {
    ...
    it("should handle errors", async () => {
      ...
      await expect(logsListApi.listGeneralLogs()).rejects.toThrow(
  ...
  describe("getGeneralLog", () => {
    ...
    it("should call HttpClient.authenticatedRequest when bearerToken provided", async () => {
      ...
      const result = await logsListApi.getGeneralLog(
        id,
        undefined,
        authStrategy,
      );
    ...
    it("should handle errors", async () => {
      ...
      await expect(logsListApi.getGeneralLog(id)).rejects.toThrow(
  ...
  describe("listAuditLogs", () => {
    ...
    it("should handle errors", async () => {
      ...
      await expect(logsListApi.listAuditLogs()).rejects.toThrow(
  ...
  describe("getAuditLog", () => {
    ...
    it("should call HttpClient.requestWithAuthStrategy when authStrategy without bearerToken", async () => {
      ...
      const result = await logsListApi.getAuditLog(
        id,
        environment,
        authStrategy,
      );
    ...
    it("should handle errors", async () => {
      ...
      await expect(logsListApi.getAuditLog(id)).rejects.toThrow(
  ...
  describe("listJobLogs", () => {
    ...
    it("should handle errors", async () => {
      ...
      await expect(logsListApi.listJobLogs()).rejects.toThrow(
  ...
  describe("getJobLog", () => {
    ...
    it("should handle errors", async () => {
      ...
      await expect(logsListApi.getJobLog(id)).rejects.toThrow(
        "Get job log failed",
      );
      expect(console.error).toHaveBeenCalledWith(
        expect.stringContaining("[LogsListApi]"),
