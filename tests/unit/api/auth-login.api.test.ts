...
describe("AuthLoginApi", () => {
  ...
  describe("initiateDeviceCode", () => {
      ...
      const mockResponse: DeviceCodeResponse = {
        ...
        data: {
          ...
          verificationUriComplete:
            "https://keycloak.example.com/device?user_code=ABCD-EFGH",
          expiresIn: 600,
          interval: 5,
        },
        timestamp: new Date().toISOString(),
    ...
    it("should handle authStrategy", async () => {
      ...
      const result = await authLoginApi.initiateDeviceCode(
        params,
        authStrategy,
      );
    ...
    it("should handle errors", async () => {
      ...
      await expect(authLoginApi.initiateDeviceCode(params)).rejects.toThrow(
  ...
  describe("pollDeviceCodeToken", () => {
    ...
    it("should handle errors", async () => {
      ...
      await expect(authLoginApi.pollDeviceCodeToken(params)).rejects.toThrow(
  ...
  describe("refreshDeviceCodeToken", () => {
    ...
    it("should handle errors", async () => {
      ...
      await expect(authLoginApi.refreshDeviceCodeToken(params)).rejects.toThrow(
  ...
  describe("getLoginDiagnostics", () => {
    ...
    it("should handle errors", async () => {
      ...
      await expect(authLoginApi.getLoginDiagnostics()).rejects.toThrow(
