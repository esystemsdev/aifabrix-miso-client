...
describe('AuthStrategyHandler', () => {
  describe('buildAuthHeaders', () => {
    it('should build headers for bearer token method', () => {
      ...
      const headers = AuthStrategyHandler.buildAuthHeaders(strategy, null, 'client-id', 'client-secret');
    ...
    it('should build headers for client-token method', () => {
      ...
      const headers = AuthStrategyHandler.buildAuthHeaders(strategy, 'test-client-token', 'client-id', 'client-secret');
    ...
    it('should handle client-credentials without client secret', () => {
      ...
      const headers = AuthStrategyHandler.buildAuthHeaders(strategy, null, 'client-id', undefined);
  ...
  describe('shouldTryMethod', () => {
    it('should return true if method is in strategy and has required data', () => {
      ...
      expect(AuthStrategyHandler.shouldTryMethod('bearer', strategy)).toBe(true);
    });
    ...
    it('should return false if method is not in strategy', () => {
      ...
      expect(AuthStrategyHandler.shouldTryMethod('bearer', strategy)).toBe(false);
    });
    ...
    it('should return true for client-token method (always available)', () => {
      ...
      expect(AuthStrategyHandler.shouldTryMethod('client-token', strategy)).toBe(true);
    });
    ...
    it('should return true for client-credentials method (always available)', () => {
      ...
      expect(AuthStrategyHandler.shouldTryMethod('client-credentials', strategy)).toBe(true);
    });
    ...
    it('should return true for api-key method with apiKey', () => {
      ...
      expect(AuthStrategyHandler.shouldTryMethod('api-key', strategy)).toBe(true);
    });
    ...
    it('should return false for api-key method without apiKey', () => {
      ...
      expect(AuthStrategyHandler.shouldTryMethod('api-key', strategy)).toBe(false);
    });
  });
  ...
  describe('mergeStrategy', () => {
    it('should return default strategy if strategy is undefined', () => {
      ...
      const merged = AuthStrategyHandler.mergeStrategy(undefined, defaultStrategy);
    ...
    it('should use provided strategy methods', () => {
      ...
      const merged = AuthStrategyHandler.mergeStrategy(strategy, defaultStrategy);
