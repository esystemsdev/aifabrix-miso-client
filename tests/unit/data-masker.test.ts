...
describe('DataMasker', () => {
  ...
  describe('containsSensitiveData', () => {
    it('should detect sensitive fields', () => {
      expect(DataMasker.containsSensitiveData({ password: 'secret' })).toBe(true);
      expect(DataMasker.containsSensitiveData({ api_token: 'token' })).toBe(true);
      expect(DataMasker.containsSensitiveData({ secret_key: 'key' })).toBe(true);
    });
