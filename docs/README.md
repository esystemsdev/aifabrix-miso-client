...
| **URL strategy**    | [configuration.md#full-urls-and-virtual-directories](configuration.md) | Full roots, optional `controllerBasePath` / DataClient `basePath`, `joinApiRoot` + `mergeRootUrlWithBasePath`; avoiding double-prefix |
